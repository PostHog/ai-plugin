...
SELECT
    ...
    date_diff('DAY', toDateTime('2026-06-27 16:11:36.963454'), expiry_time) AS recording_ttl,
    greaterOrEquals(max(s._timestamp), toDateTime('2026-06-27 16:06:36.962692')) AS ongoing,
...
WHERE
    and(greaterOrEquals(s.min_first_timestamp, toDateTime('2026-06-24 00:00:00.000000')), lessOrEquals(s.min_first_timestamp, toDateTime('2026-06-27 16:11:36.962838')))
GROUP BY
    session_id
HAVING
    and(greaterOrEquals(expiry_time, toDateTime('2026-06-27 16:11:36.963356')), equals(max(s.is_deleted), 0), greater(active_seconds, 5.0))
ORDER BY
    start_time DESC,
    session_id DESC
LIMIT 50000
