...
SELECT
    ...
    date_diff('DAY', toDateTime('2026-07-11 10:14:03.593468'), expiry_time) AS recording_ttl,
    greaterOrEquals(max(s._timestamp), toDateTime('2026-07-11 10:09:03.592936')) AS ongoing,
...
WHERE
    and(greaterOrEquals(s.min_first_timestamp, toDateTime('2026-07-08 00:00:00.000000')), lessOrEquals(s.min_first_timestamp, toDateTime('2026-07-11 10:14:03.593081')))
GROUP BY
    session_id
HAVING
    and(greaterOrEquals(expiry_time, toDateTime('2026-07-11 10:14:03.593385')), equals(max(s.is_deleted), 0), greater(active_seconds, 5.0))
ORDER BY
    start_time DESC,
    session_id DESC
LIMIT 50000
