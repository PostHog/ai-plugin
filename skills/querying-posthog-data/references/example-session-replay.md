...
SELECT
    ...
    date_diff('DAY', toDateTime('2026-06-29 10:08:07.053084'), expiry_time) AS recording_ttl,
    greaterOrEquals(max(s._timestamp), toDateTime('2026-06-29 10:03:07.052167')) AS ongoing,
...
WHERE
    and(greaterOrEquals(s.min_first_timestamp, toDateTime('2026-06-26 00:00:00.000000')), lessOrEquals(s.min_first_timestamp, toDateTime('2026-06-29 10:08:07.052376')))
GROUP BY
    session_id
HAVING
    and(greaterOrEquals(expiry_time, toDateTime('2026-06-29 10:08:07.052962')), equals(max(s.is_deleted), 0), greater(active_seconds, 5.0))
ORDER BY
    start_time DESC,
    session_id DESC
LIMIT 50000
